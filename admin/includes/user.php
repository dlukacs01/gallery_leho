...
class User extends Db_object {
	...
	protected static $db_table_fields = array('username', 'password', 'first_name', 'last_name', 'user_image', 'cv_hu', 'cv_en', 'news_hu', 'news_en', 'bibliography_hu', 'bibliography_en', 'links', 'email', 'phone');
	...
	public $news_hu;
	public $news_en;
	public $bibliography_hu;
	public $bibliography_en;
	public $links;
	public $email;
	public $phone;
